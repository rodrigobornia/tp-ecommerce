...
class TestProducto {
    ...
    public void testPackAudioMovilSimple() {
        ...
        // Parámetros: nombre, descripcion, descuento, precio (pasamos 0.0), stock
        Paquete packAudio = new Paquete("Pack Audio Móvil", "Combo ideal para viajes", 15, 0.0, 10);
    ...
    public void testPaquetesAnidadosRecursivos() {
        ...
        Paquete packAudio = new Paquete("Pack Audio Móvil", "Combo de audio", 15, 0.0, 10);
        packAudio.getProductos().add(auriculares);
        packAudio.getProductos().add(funda);
        packAudio.getProductos().add(cable);
        ...
        Paquete kitHomeOffice = new Paquete("Kit Home Office", "Todo para trabajar desde casa", 10, 0.0, 5);
